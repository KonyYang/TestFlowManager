        ...
        "src": {
            ...
            "features": {
                ...
                "ltr_manager": {
                    ...
                    "view": [
                        "__init__.py",
                        "ltr_viewer_dialog.py"
                    ],
                    "controller": [
                        "__init__.py",
                        "ltr_viewer_controller.py"
                    ],
                    "service": [
                        "__init__.py",
                        "ltr_viewer_service.py"
                    ]
                }
            }
        },
...
def create_project_structure(project_name=None, base_path="."):
    ...
    structure = {
            ...
            "features": {
                ...
                "ltr_manager": {
                    ...
                    "view": {
                        ...
                        "components": [
                            "__init__.py",
                            "ltr_field_widgets.py"
                        ],
                        "ltr_editor_dialog.py": None
                    },
                    "controller": [
                        "__init__.py",
                        "ltr_viewer_controller.py",
                        "ltr_editor_controller.py"
                    ],
                    "service": [
                        "__init__.py",
                        "ltr_viewer_service.py",
                        "ltr_editor_service.py"
                    ],
                    "utils": [
                        "__init__.py",
                        "field_config_loader.py"
                    ]
                },
                "email_extractor": {
                    "__init__.py": None,
                    "model": [
                        "__init__.py",
                        "email_extractor_data.py"
                    ],
                    "view": [
                        "__init__.py",
                        "email_selector_dialog.py"
                    ],
                    "controller": [
                        "__init__.py",
                        "email_extractor_controller.py"
                    ],
                    "service": [
                        "__init__.py",
                        "email_extractor_service.py"
                    ]
                },
                "document_parser": {
                    "__init__.py": None,
                ...
                "project_creator": {
                    ...
                    "model": [
                        "__init__.py",
                        "project_creator_data.py"
                    ],
                    "view": [
                        "__init__.py",
                        "project_creator_dialog.py"
                    ],
                    "controller": [
                        "__init__.py",
                        "project_creator_controller.py"
                    ],
                    "service": [
                        "__init__.py",
                        "project_creator_service.py"
                    ]
                }
            }
        },
        "tests": [
            "__init__.py",
            "test_example.py",
            "test_integration_ltr_password.py",
            "test_integration_ltr_view.py"
        ],
        "docs": [
            "design.md",
            "api_reference.md"
