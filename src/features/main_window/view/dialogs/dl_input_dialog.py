...
class DLInputDialog(QDialog):
    ...
    def _setup_ui(self):
        ...
        self.dl_input.setFont(FontUtils.get_scaled_font(9))  # 使用更小的字体大小
        ...
        self.confirm_button.setFont(FontUtils.get_scaled_font(8))  # 使用更小的字体大小
        self.confirm_button.setEnabled(False)

        self.skip_button = QPushButton("跳过")
        self.skip_button.clicked.connect(self._on_skip)
        self.skip_button.setFont(FontUtils.get_scaled_font(8))  # 使用更小的字体大小

        self.cancel_button = QPushButton("取消")
        self.cancel_button.clicked.connect(self.reject)
        self.cancel_button.setFont(FontUtils.get_scaled_font(8))  # 使用更小的字体大小
