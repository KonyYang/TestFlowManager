...
class BasicInfoDialog(BaseInfoDialog):
    """BasicInfoDialog
    项目基本信息对话框类
    用于显示和编辑项目基本信息
    """
    ...
    def __init__(self, project_data, parent=None, project_data_file_path=None):
        ...
        Args:
            ...
            parent: 父窗口
        """
        logger.info(f"创建项目基本信息对话框，初始数据: {project_data}")
